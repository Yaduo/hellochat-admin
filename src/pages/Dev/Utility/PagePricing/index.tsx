...
const monthData = [
  {
    ...
    title: "Stater",
    price: "29",
    desc: "For small teams trying out HelloChat for an unlimited period of time",
  },
  {
    id: 2,
    title: "Professional",
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <MetaTags>
          <title>Pricing Page | HelloChat Admin</title>
        </MetaTags>
        <Container fluid>
          {/* Render Breadcrumbs */}
                          ...
                          <div className="d-flex align-items-center">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="fw-normal mb-0 text-muted">
                                For small teams trying out HelloChat for an
